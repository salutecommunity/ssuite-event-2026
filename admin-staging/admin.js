...
function renderOverview(host, overview) {
  ...
  if (overview.environment === "isolated_staging") host.append(element("p", "notice", overview.notice || "Isolated staging does not contain production records."));
